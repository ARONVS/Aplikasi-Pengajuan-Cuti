    ...
    <div class="sidebar-wrapper group">
      ...
      <div class="logo-segment">
        <a class="flex items-center" href="index.html">
          ...
          <span class="ltr:ml-3 rtl:mr-3 text-xl font-Inter font-bold text-slate-900 dark:text-white">WELCOME!!</span>
        </a>
        <!-- Sidebar Type Button -->
      ...
      <div class="sidebar-menus bg-white dark:bg-slate-800 py-2 px-4 h-[calc(100%-80px)] overflow-y-auto z-50" id="sidebar_menus">
        <ul class="sidebar-menu">
          ...
          <li class="">
            <a href="{{ route ('jabatan.home') }}" class="navItem">
              <span class="flex items-center">
          ...
          <li class="">
            <a href="{{ route ('jenis_cuti.home') }}" class="navItem">
              <span class="flex items-center">
            <iconify-icon class=" nav-icon" icon="heroicons-outline:identification"></iconify-icon>
          ...
          <li class="">
            <a href="{{ route ('users.home') }}" class="navItem">
              <span class="flex items-center">
          ...
          <li class="">
            <a href="{{ route ('admin_cuti.home') }}" class="navItem">
              <span class="flex items-center">
        ...
        <div class="bg-slate-900 mb-10 mt-24 p-4 relative text-center rounded-2xl text-white" id="sidebar_bottom_wizard">
          ...
          <div class="mt-6">
            <a href="https://diskominfo.tomohon.go.id/" class="bg-white hover:bg-opacity-80 text-slate-900 text-sm font-Inter rounded-md w-full block py-2 font-medium">
              Go!
            </a>
          </div>
        </div>
